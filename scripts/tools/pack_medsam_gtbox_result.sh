...
cp scripts/setup/setup_medsam_caries.sh "$OUT/submit_scripts/" 2>/dev/null || true
cp scripts/jobs/submitjob_medsam_gtbox_caries.sh "$OUT/submit_scripts/" 2>/dev/null || true
