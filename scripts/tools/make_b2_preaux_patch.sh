...
cat > scripts/jobs/submitjob_b2_preaux_rbsg_auglite_e200_constlr_bs6.sh <<'EOF'
#!/bin/bash
#SBATCH -J b2_preaux
#SBATCH -p gpu
#SBATCH -N 1
...
cat > scripts/jobs/submitjob_smoke_b2_preaux_e3.sh <<'EOF'
#!/bin/bash
#SBATCH -J smoke_b2pa
#SBATCH -p gpu
#SBATCH -N 1
...
chmod +x scripts/jobs/submitjob_b2_preaux_rbsg_auglite_e200_constlr_bs6.sh
chmod +x scripts/jobs/submitjob_smoke_b2_preaux_e3.sh

echo "===== Shell syntax check ====="
bash -n scripts/jobs/submitjob_b2_preaux_rbsg_auglite_e200_constlr_bs6.sh
bash -n scripts/jobs/submitjob_smoke_b2_preaux_e3.sh
...
ls -lh scripts/jobs/submitjob_b2_preaux_rbsg_auglite_e200_constlr_bs6.sh
ls -lh scripts/jobs/submitjob_smoke_b2_preaux_e3.sh

echo "===== Next step ====="
echo "1) First submit smoke test:"
echo "   sbatch scripts/jobs/submitjob_smoke_b2_preaux_e3.sh"
echo
echo "2) Watch smoke log:"
echo "   tail -f runs/logs/smoke_b2_preaux_*.out"
echo
echo "3) If smoke passes, submit full run:"
echo "   sbatch scripts/jobs/submitjob_b2_preaux_rbsg_auglite_e200_constlr_bs6.sh"
