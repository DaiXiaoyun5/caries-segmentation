...
cp scripts/jobs/submitjob_unet_auglite_e200_constlr_bs6.sh "$OUT/submit_scripts/" 2>/dev/null || true
cp scripts/jobs/submitjob_classic_resunet_auglite_e200_constlr_bs6.sh "$OUT/submit_scripts/" 2>/dev/null || true
