...
class CBSABlock(nn.Module):
    ...
    It keeps the parameter-free SimAM energy attention, then adds a lightweight
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="smoke_resnet34_unet3p_cbsa")
