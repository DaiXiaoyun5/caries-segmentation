...
def main(args):
    ...
    config["experiment"] = "AUG1-E200-ConstLR: ResNet34-U-Net + CBSA + MKDC with AugLite, 200 epochs, constant lr"
    config["note"] = "Based on AUG1/P2-AugLite. Model and augmentation are unchanged. Training is extended to 200 epochs with constant AdamW learning rate 3e-4. Validation/test are not augmented."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_auglite_e200_constlr_bs6")
