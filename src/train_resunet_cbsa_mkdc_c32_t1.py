...
class ResNet34UNetCBSAMKDCC32(nn.Module):
    """
    P2:
...
def main(args):
    ...
    config["model_class"] = "ResNet34UNetCBSAMKDCC32"
    config["experiment"] = "T1/P2-C32: ResNet34-U-Net + CBSA + MKDC with decoder_channels=(256,128,64,32,32)"
    config["note"] = "Parameter tuning against P2: only the final decoder output channel is increased from 16 to 32; CBSA and MKDC placement remain unchanged."
    ...
    print("=" * 80)
    print("Model ready: T1/P2-C32 ResNet34-U-Net + CBSA + MKDC")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_c32_t1_e50_bs6")
    ...
    parser.add_argument("--decoder-channels", type=str, default="256,128,64,32,32")
