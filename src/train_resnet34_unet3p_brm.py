...
class BoundaryRefinementModule(nn.Module):
    ...
    2. 尽量改善边界模糊和误分问题；
    3. 本实验不额外使用 edge loss，方便和已有 Edge 分支做干净对比。
    """
...
# =========================
class ResNet34UNet3PlusBRM(nn.Module):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="smoke_resnet34_unet3p_brm")
