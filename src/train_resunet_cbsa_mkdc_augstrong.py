...
def main(args):
    ...
    config["experiment"] = "AUG2/P2-AugStrong: ResNet34-U-Net + CBSA + MKDC with stronger nnU-Net-like online augmentation"
    config["note"] = "Model architecture is unchanged from P2. Only the training set uses stronger online augmentation: larger rotation/scaling/translation, horizontal flip, occasional vertical flip, brightness/contrast/gamma, Gaussian noise and blur. Validation/test are not augmented."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_augstrong_e100_bs6")
    parser.add_argument("--image-size", type=int, default=512)
    parser.add_argument("--augment-profile", type=str, default="strong", choices=["lite", "strong", "none"])
