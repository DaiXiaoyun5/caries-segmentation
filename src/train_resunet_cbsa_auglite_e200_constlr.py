...
def main(args):
    ...
    config["experiment"] = "AUG-M3-E200-ConstLR: ResNet34-U-Net + CBSA without MKDC, AugLite, 200 epochs, constant lr"
    config["note"] = "Based on M3/CBSA-only. MKDC is removed. AugLite is used for training only. Training is extended to 200 epochs with constant AdamW learning rate 3e-4."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_auglite_e200_constlr_bs6")
