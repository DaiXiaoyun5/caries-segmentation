...
def main(args):
    ...
    config["experiment"] = "R34U-AugLite-E200-ConstLR: plain ResNet34-U-Net with AugLite, 200 epochs, constant lr"
    config["note"] = "Plain ResNet34-U-Net without CBSA and MKDC. AugLite is used for training only. Training is extended to 200 epochs with constant AdamW learning rate 3e-4."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resnet34_unet_auglite_e200_constlr_bs6")
