...
class ResNet34UNetPlain(nn.Module):
    """
    Plain ResNet34-U-Net with AugLite training.

    This model removes both CBSA and MKDC. It is used to test how much
    of the performance gain comes from AugLite training alone.

    Forward:
        image -> ResNet34 encoder -> SMP U-Net decoder -> segmentation head -> mask logits
    """
    def __init__(
        self,
...
def main(args):
    ...
    config["model_class"] = "ResNet34UNetPlain"
    config["experiment"] = "R34U-AugLite-E200-CosLR: plain ResNet34-U-Net with AugLite, 200 epochs, cosine LR decay"
    config["note"] = "Plain ResNet34-U-Net without CBSA and MKDC. AugLite is used for training only. Training is extended to 200 epochs with cosine learning-rate decay from 3e-4 to 1e-6."
    ...
    print("=" * 80)
    print("Model ready: plain ResNet34-U-Net + AugLite, without CBSA/MKDC")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resnet34_unet_auglite_e200_coslr_bs6")
