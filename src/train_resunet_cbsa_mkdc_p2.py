...
def main(args):
    ...
    config["experiment"] = "P2: ResNet34-U-Net + CBSA + MKDC/MKIR official-block extraction"
    config["note"] = "MKDC/MKIR block extracted from official SLDGroup/MK-UNet mkunet_network.py; pconv2 Conv+BN preserved; inserted as decoder-output refinement."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_p2_e50_bs6")
