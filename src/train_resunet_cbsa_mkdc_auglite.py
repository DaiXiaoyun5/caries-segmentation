...
def main(args):
    ...
    config["experiment"] = "AUG1/P2-AugLite: ResNet34-U-Net + CBSA + MKDC with mild nnU-Net-like online augmentation"
    config["note"] = "Model architecture is unchanged from P2. Only the training set uses online mild augmentation: rotation, scaling, translation, horizontal flip, brightness/contrast/gamma, light Gaussian noise and blur. Validation/test are not augmented."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_auglite_e100_bs6")
