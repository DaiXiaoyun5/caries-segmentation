...
class ResNet34UNetCBSAMKDCMK2(nn.Module):
    """
    P2:
...
def main(args):
    ...
    config["model_class"] = "ResNet34UNetCBSAMKDCMK2"
    config["experiment"] = "T3/P2-MK2: ResNet34-U-Net + CBSA + MKDC depth=2"
    config["note"] = "Parameter tuning against P2: only MKDC depth is increased from 1 to 2; CBSA, decoder, kernel sizes, and expansion factor remain unchanged."
    ...
    print("=" * 80)
    print("Model ready: T3/P2-MK2 ResNet34-U-Net + CBSA + MKDC depth=2")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_mk2_t3_e50_bs6")
    ...
    parser.add_argument("--mk-depth", type=int, default=2)
