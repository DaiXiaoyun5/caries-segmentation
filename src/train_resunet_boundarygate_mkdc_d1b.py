...
class BoundaryGateResidualCueBlock(nn.Module):
    """
...
class ResNet34UNetBoundaryGateMKDC(nn.Module):
    """
    D1b: ResNet34-U-Net + Boundary-gate residual cue + MKDC/MKIR
    ...
    def __init__(
        ...
        self.boundary_cue = BoundaryGateResidualCueBlock(
            alpha=cbsa_alpha,
            beta=cbsa_beta,
        )
...
def main(args):
    ...
    config["model_class"] = "ResNet34UNetBoundaryGateMKDC"
    config["experiment"] = "D1b: ResNet34-U-Net + Boundary-gate residual cue + MKDC/MKIR"
    config["note"] = "CBSA is replaced by boundary-gate residual cue: att = 1 + alpha*boundary; out = x + beta*x*att. MKDC remains decoder-output refinement."
    ...
    model = ResNet34UNetBoundaryGateMKDC(
    ...
    print("=" * 80)
    print("Model ready: D1b ResNet34-U-Net + Boundary-gate residual cue + MKDC")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_boundarygate_mkdc_d1b_e50_bs6")
