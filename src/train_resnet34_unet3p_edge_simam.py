...
class SimAMBlock(nn.Module):
    ...
    It enhances neurons according to spatial energy.
    """
...
class ResNet34UNet3PlusEdgeSimAM(ResNet34UNet3PlusEdge):
    """
    ResNet34-UNet3+ + Edge Branch + SimAM.
    SimAM is inserted after decoder full-scale fusion features.
    """
    def __init__(
        self,
...
def main(args):
    ...
    model = ResNet34UNet3PlusEdgeSimAM(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="smoke_resnet34_unet3p_edge_simam")
