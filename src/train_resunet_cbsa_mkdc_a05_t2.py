...
class ResNet34UNetCBSAMKDCA05(nn.Module):
    """
    P2:
...
def main(args):
    ...
    config["model_class"] = "ResNet34UNetCBSAMKDCA05"
    config["experiment"] = "T2/P2-A05: ResNet34-U-Net + CBSA(alpha=0.5) + MKDC"
    config["note"] = "Parameter tuning against P2: only CBSA boundary modulation strength alpha is reduced from 1.0 to 0.5; architecture and MKDC remain unchanged."
    ...
    print("=" * 80)
    print("Model ready: T2/P2-A05 ResNet34-U-Net + CBSA(alpha=0.5) + MKDC")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_a05_t2_e50_bs6")
    ...
    parser.add_argument("--cbsa-alpha", type=float, default=0.5)
