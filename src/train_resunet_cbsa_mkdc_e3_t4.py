...
class ResNet34UNetCBSAMKDCE3(nn.Module):
    """
    P2:
...
def main(args):
    ...
    config["model_class"] = "ResNet34UNetCBSAMKDCE3"
    config["experiment"] = "T4/P2-E3: ResNet34-U-Net + CBSA + MKDC expansion_factor=3"
    config["note"] = "Parameter tuning against P2: only MKDC expansion factor is increased from 2 to 3; CBSA, decoder, kernel sizes, and MKDC depth remain unchanged."
    ...
    print("=" * 80)
    print("Model ready: T4/P2-E3 ResNet34-U-Net + CBSA + MKDC expansion=3")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="resunet_cbsa_mkdc_e3_t4_e50_bs6")
    ...
    parser.add_argument("--mk-expansion-factor", type=int, default=3)
