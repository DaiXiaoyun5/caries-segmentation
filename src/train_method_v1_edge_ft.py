...
# Focal Tversky Loss
# =========================
def focal_tversky_loss_from_logits(logits, targets, alpha=0.3, beta=0.7, gamma=0.75, eps=1e-7):
    """
    logits : [B,1,H,W]
    targets: [B,1,H,W], 0/1
    """
...
def run_one_epoch(
    ...
    for images, masks, edges, _, _ in loader:
        ...
        with torch.set_grad_enabled(train):
            ...
            seg_loss = focal_tversky_loss_from_logits(
                seg_logits, masks,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-name", type=str, default="smoke_method_v1_edge_ft")
