...
cat > submitjob_b3_brr_rbsg_mbc_auglite_e200_constlr_bs6.sh <<'EOF'
#!/bin/bash
#SBATCH -J b3_brr_mbc
#SBATCH -p gpu
#SBATCH -N 1
...
cat > submitjob_smoke_b3_brr_rbsg_mbc_e3.sh <<'EOF'
#!/bin/bash
#SBATCH -J smoke_b3
#SBATCH -p gpu
#SBATCH -N 1
...
chmod +x submitjob_b3_brr_rbsg_mbc_auglite_e200_constlr_bs6.sh
chmod +x submitjob_smoke_b3_brr_rbsg_mbc_e3.sh

echo "===== Shell syntax check ====="
bash -n submitjob_b3_brr_rbsg_mbc_auglite_e200_constlr_bs6.sh
bash -n submitjob_smoke_b3_brr_rbsg_mbc_e3.sh
...
ls -lh submitjob_b3_brr_rbsg_mbc_auglite_e200_constlr_bs6.sh
ls -lh submitjob_smoke_b3_brr_rbsg_mbc_e3.sh

echo "===== Next step ====="
echo "1) First submit smoke test:"
echo "   sbatch submitjob_smoke_b3_brr_rbsg_mbc_e3.sh"
echo
echo "2) Watch smoke log:"
echo "   tail -f runs/logs/smoke_b3_mbc_*.out"
echo
echo "3) If smoke passes, submit full B3:"
echo "   sbatch submitjob_b3_brr_rbsg_mbc_auglite_e200_constlr_bs6.sh"
