#!/bin/bash
#SBATCH -J b30_ssgcb_l
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 4
#SBATCH --gres=gpu:1
#SBATCH -o runs/logs/b30_ssgcb_light_%j.out
...
echo "===== RUN B30-light: B2 + SSGCB dynamic bottleneck context ====="
python src/train_resnet34_unet_brr_b30_ssgcb_light_e200.py \
  --run-name b30_ssgcb_light_auglite_e200_constlr_bs6 \
  --image-size 512 \
...
echo "===== TEST METRICS ====="
cat runs/b30_ssgcb_light_auglite_e200_constlr_bs6/test_metrics.json

echo "===== PER-CASE SUMMARY ====="
cat runs/b30_ssgcb_light_auglite_e200_constlr_bs6/per_case_metrics_summary.json

echo "===== DONE B30-light SSGCB ====="
