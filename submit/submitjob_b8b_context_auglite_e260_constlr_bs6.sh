...
#SBATCH -c 4
#SBATCH --gres=gpu:1
#SBATCH -o runs/logs/b8b_context_e260_%j.out
...
RUN_NAME=b8b_b2_context_bottleneck_auglite_e260_constlr_bs6
...
echo "===== RUN B8B E260: B2 + Multi-scale Context Bottleneck, lr=3e-4 ====="
