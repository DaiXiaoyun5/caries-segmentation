...
#SBATCH -c 4
#SBATCH --gres=gpu:1
#SBATCH -o runs/logs/b30_ssgcb_light_e260_%j.out
...
RUN_NAME=b30_ssgcb_light_auglite_e260_constlr_bs6
...
echo "===== RUN B30-light E260: B2 + SSGCB, lr=3e-4 ====="
...
echo "===== PER-CASE EVAL B30-light E260 ====="
...
echo "===== DONE B30-light E260 LR3E-4 ====="
